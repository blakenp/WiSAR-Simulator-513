...
Below is an example animation of how our logger works for outputting animations of our simulation. Below is a gif generated by Claude just for this draft, but for the final project once we have everything finished we will replace the below with actual results and findings.

![Simulation Example Animation](search_sim/animations/example_animation.gif)
